...
Address validate(String address) {
  ...
  try {
    ...
    if (e is Exception) {
      ...
      Get.snackbar(
        "Error",
        "Invalid address, Enter right Address",
        backgroundColor: whiteColor,
        colorText: Colors.black,
      );
      ...
      throw Base58CheckException(Exception('Unknown error occurred'));
    }
  }
  ...
  walletController.btcAddressValidation.value = true;
...
Address validateSegwit(String address) {
  ...
  try {
    ...
    if (e is Exception) {
      ...
      throw SegwitException(Exception('Unknown error occurred'));
    }
  }
